  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <section className="flex bg-very-light-grayish-blue-L dark:bg-very-bark-blue-D h-2/3">
        <div className="mx-auto w-[21rem] sm:w-[30rem] md:w-[43rem] lg:w-[50rem] flex flex-col gap-y-10 -mt-52 lg:-mt-48">
          <Header />
          <Main />
          <Filter
            className={
              "md:hidden bg-very-light-gray-L dark:bg-very-dark-desaturated-blue-D rounded-md shadow-xl p-3 -my-6 sm:my-0"
            }
          />
          <Footer />
        </div>
